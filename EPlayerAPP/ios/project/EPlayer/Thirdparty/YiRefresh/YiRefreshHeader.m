...
- (void)header
{
    ...
    float scrollHeight =headerHeight;
    float imageWidth=13;
    ...
    CGFloat x = (scrollWidth - labelWidth) * 0.5;
    CGFloat y = (scrollHeight - labelHeight) * 0.5 + 7.5;
    headerLabel=[[UILabel alloc] initWithFrame:CGRectMake(x, y, labelWidth, labelHeight)];
    ...
    headerIV=[[UIImageView alloc] initWithFrame:CGRectMake((scrollWidth-labelWidth)/2-imageWidth, 7.5, imageWidth, imageHeight)];
    [headerView addSubview:headerIV];
    headerIV.image=[UIImage imageNamed:@"down"];

    activityView = [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleGray];
    activityView.frame=CGRectMake((scrollWidth-labelWidth)/2-imageWidth, 7.5, imageWidth, imageHeight);
