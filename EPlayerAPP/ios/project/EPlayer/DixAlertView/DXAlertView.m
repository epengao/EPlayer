...
#define kButtonBottomOffset 10.0f
        ...
        [self.rightBtn setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithRed:90.0/256.0 green:53.0/256.0 blue:200.0/256.0 alpha:1]] forState:UIControlStateNormal];
