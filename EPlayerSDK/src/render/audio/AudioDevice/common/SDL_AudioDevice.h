...
#ifndef SDL_AUDIO_DEVICE_H
#define SDL_AUDIO_DEVICE_H
...
class SDL_AudioDevice : public AudioDeviceI
{
public:
    SDL_AudioDevice(AudioRender* pAudioRender);
    ~SDL_AudioDevice();
